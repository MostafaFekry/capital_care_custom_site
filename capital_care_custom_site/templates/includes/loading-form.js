		...
		$(this).validate({
			submitHandler: function(form) {
				...
				var $form = $(form),
					...
					$contactforminputs = $form.find('.contact-form-inputs'),
				...
				frappe.call({
					method: 'capital_care_custom_site.utils.create_lead_for_landingpage',
					args: {
						lead: $('[name="name"]').val(),
						...
						interestedin: $('[name="interestedin"]').val(),
						job: $('[name="job"]').val()						
					},
					callback: (r) => {
						if(r.message==="okay"){
							...
							$contactforminputs.addClass('d-none');
